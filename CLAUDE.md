...
description: "Git branch, commit, and merge policy in force for this repository, scaffolded by the git-governance plugin: the branch flow, Conventional Commits requirement, the autonomous-to-develop and human-gated-to-staging/main permission model, and the local and remote validation layers."
status: active
version: "1.0.0"
created: 2026-08-01
updated: 2026-08-01
...
related: [org-governance-adoption, engineering-standards, contributing]
---
